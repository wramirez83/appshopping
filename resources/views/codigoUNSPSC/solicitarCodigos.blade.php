    ...
    <div class="card">
      @if(session('status'))
        <div class="alert alert-success">
          <strong>Código Solicitado</strong>
        </div>
      @endif
        <form action="{{ Route('solicitandoCodigoUNSPSC') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary btn-sm">
                <i class="fa fa-dot-circle-o"></i> Guardar y Solicitar
            </button>
